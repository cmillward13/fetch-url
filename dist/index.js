...
const utils_1 = __nccwpck_require__(141);
/**
 * Commands
 *
 * Command Format:
...
var iconvLite = __nccwpck_require__(41);
// Load Iconv from an external file to be able to disable Iconv for webpack
// Add /\/iconv-loader$/ to webpack.IgnorePlugin to ignore it
var Iconv = __nccwpck_require__(917);
...
try {
    ...
    iconv_package = 'iconv';
    Iconv = __nccwpck_require__(549).Iconv;
} catch (E) {
...
var urllib = __nccwpck_require__(835);

module.exports.U = CookieJar;
...
var urllib = __nccwpck_require__(835);
var utillib = __nccwpck_require__(669);
var zlib = __nccwpck_require__(761);
var dns = __nccwpck_require__(881);
var Stream = __nccwpck_require__(413).Readable;
var CookieJar = __nccwpck_require__(656)/* .CookieJar */ .U;
var encodinglib = __nccwpck_require__(270);
...
var Buffer = __nccwpck_require__(926).Buffer;
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(108) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(417) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(803) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(803).concat(__nccwpck_require__(419)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(803).concat(__nccwpck_require__(419)) },
        gb18030: function() { return __nccwpck_require__(351) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(13) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(104) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(104).concat(__nccwpck_require__(612)) },
...
var StringDecoder = __nccwpck_require__(304).StringDecoder;
...
module.exports = function (iconv) {
    ...
    iconv.extendNodeEncodings = function extendNodeEncodings() {
        ...
        // -- SlowBuffer -----------------------------------------------------------
        var SlowBuffer = __nccwpck_require__(293).SlowBuffer;
...
var bomHandling = __nccwpck_require__(205),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __nccwpck_require__(886); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __nccwpck_require__(776)(iconv);
    }

    // Load Node primitive extensions.
    __nccwpck_require__(275)(iconv);
}
...
var Buffer = __nccwpck_require__(293).Buffer,
    Transform = __nccwpck_require__(413).Transform;
...
(() => {
const fetch = __nccwpck_require__(43)
